        ...
        <h3 class="text-white text-xl font-semibold flex items-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none"
            ...
            <path stroke-linecap="round" stroke-linejoin="round"
                  d="M3 5h12M9 3v2m4 12h6m-3-3v6m-6-3H3"/>
          </svg>
      ...
      <div class="p-6">
        ...
        <form action="{{ route('kontak.update') }}" method="POST">
          ...
          <div class="mb-5">
            ...
            <div class="flex items-center border rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-green-500">
              <span class="px-3 text-gray-500">
                <!-- Heroicon: Instagram -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-pink-500" fill="currentColor"
                     viewBox="0 0 24 24">
                  ...
                  <path d="M12 7a5 5 0 100 10 5 5 0 000-10zm0 1.5a3.5 3.5 0 110 7 3.5 3.5 0 010-7zM17.75 6a.75.75 0 100 1.5.75.75 0 000-1.5z"/>
                </svg>
              </span>
              <input
                id="instagram"
          ...
          <div class="mb-5">
            ...
            <div class="flex items-center border rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-green-500">
              <span class="px-3 text-gray-500">
                <!-- Heroicon: Facebook (custom) -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" fill="currentColor"
                     viewBox="0 0 24 24">
                  <path d="M22 12a10 10 0 10-11.5 9.87v-6.99h-2.2V12h2.2V9.8c0-2.17 1.3-3.38 3.29-3.38.95 0 1.94.17 1.94.17v2.14h-1.1c-1.08 0-1.42.67-1.42 1.36V12h2.42l-.39 2.88h-2.03v6.99A10 10 0 0022 12z"/>
                </svg>
              </span>
              <input
                id="facebook"
