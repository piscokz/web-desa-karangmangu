  ...
  <div class="container mx-auto px-4 py-8" x-data="{
      ...
      jenisOther: '{{ !in_array(old('jenis_kelamin', $penduduk->jenis_kelamin), ['Laki-laki','Perempuan']) 
      ...
      agamaOther: '{{ !in_array(old('agama', $penduduk->agama), ['Islam','Kristen','Katolik','Hindu','Buddha','Konghucu']) 
      ...
      statusOther: '{{ !in_array(old('status_perkawinan', $penduduk->status_perkawinan), ['Belum Kawin','Kawin','Cerai Hidup','Cerai Mati']) 
      ...
      golOther: '{{ !in_array(old('gol_darah', $penduduk->gol_darah), ['A','B','AB','O']) 
      ...
      shdkOther: '{{ !in_array(old('shdk', $penduduk->shdk), ['Kepala Keluarga','Istri','Anak','Orang Tua']) 
