...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-green-800 mb-6">Tambah Dusun</h1>
    ...
    <div class="bg-white shadow rounded-2xl p-6">
        <form action="{{ route('dusun.store') }}" method="POST" class="space-y-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_dusun" id="nama_dusun" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-200" required placeholder="Masukkan Nama Dusun">
            </div>
            <div class="flex justify-end space-x-2 <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-500 transition">Simpan</button>
