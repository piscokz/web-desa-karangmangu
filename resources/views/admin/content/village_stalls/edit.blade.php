...
@section('content')
    ...
    <section class="animate_animated animate_fadeInUp bg-gray-50 p-6 rounded-2xl shadow-md max-w-3xl mx-auto">
        ...
        <form action="{{ route('lapak_desa.update', $village_stall->id_produk) }}" method="POST" enctype="multipart/form-data"
            ...
            {{-- Pemilik --}}
            <div>
                <label for="id_penduduk" class="block text-gray-700 font-medium mb-1">
                    Pemilik (Penduduk)
                </label>
                <select id="id_penduduk" name="id_penduduk"
                    class="select2 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-400">
            ...
            <div>
                ...
                <input type="text" id="phoneInput" name="no_telepon"
                    value="{{ old('no_telepon', $village_stall->no_telepon) }}" maxlength="14" placeholder="08*--*"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-400"
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi-edit"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-400" rows="4">{{ old('deskripsi', $village_stall->deskripsi) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if ($village_stall->gambar_produk)
                    <img src="{{ asset('storage/' . $village_stall->gambar_produk) }}" alt="Gambar Lama"
    ...
    <script>
        CKEDITOR.replace('deskripsi-create', {
            height: 200
        });
